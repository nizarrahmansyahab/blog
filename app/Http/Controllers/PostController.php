...
class PostController extends Controller
{
    ...
    public function update(Request $request, $id)
    {
        ...
        return redirect()->route('post.index')->with('success','Postingan anda berhasil diedit'); 
    ...
    public function restore($id){
        ...
        return redirect()->back()->with('success','Artikel Berhasil DiRestore (Silahkan cek list artikel)');
    }
